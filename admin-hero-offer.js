...
(()=>{
  ...
  panel.innerHTML=`
    <div class="panel" style="max-width:980px">
      ...
      <div class="two">
        <div class="field"><label>Alto imagen · computadora (px)</label><input id="hoImgDesktop" type="number" min="220" max="650" value="340"></div>
        <div class="field"><label>Alto imagen · celular (px)</label><input id="hoImgMobile" type="number" min="200" max="520" value="265"></div>
      </div>
  ...
  async function loadHeroAdmin(){
    ...
    $('hoImgDesktop').value=Number.isFinite(Number(v.image_height_desktop))?v.image_height_desktop:340;
    $('hoImgMobile').value=Number.isFinite(Number(v.image_height_mobile))?v.image_height_mobile:265;
  ...
  $('hoSave').onclick=async()=>{
    ...
    try{
      ...
      const payload={
        ...
        image_height_desktop:Number($('hoImgDesktop').value)||340,
        image_height_mobile:Number($('hoImgMobile').value)||265,
